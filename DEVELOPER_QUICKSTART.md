...
// Instantiate your baseline data objectProtectedSystemState raw_data = { 9012, 142.5f, -88.2f, 0xABCDE12345 };
// Pass your custom data type into the template slotEnclaveSDK::ProtectedVariable<ProtectedSystemState> secure_matrix;
...
ProtectedSystemState live_snapshot = secure_matrix.Get();std::cout << "Active Variable ID: " << live_snapshot.variable_id << "\n";
...
# Link your app binary targetsadd_executable(my_protected_app src/main.cpp)
