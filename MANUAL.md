...
4. Load the compiled hypervisor kernel module (.ko) directly into physical CPU memory:
...
5. Compile the target architectural binaries into production driver release states (.sys):
   > cmake --build . --config Release
